...
object neighbor{
  ...
  def main(args: Array[String]): Unit = {
   ...
   // System.setProperty("hadoop.home.dir", "HADOOP_HOME");
	...
	//val writer = new PrintWriter(new File(result_path + "/result_"+args(0)+"_"+args(1)+"_"+ args(2)+"_"+args(5)+"_neighbor_sampling_v0.7.3.csv"))
	val writer = new PrintWriter(new File(result_path + "/result_"+args(0)+"_"+args(1)+"_"+ args(2)+"_"+args(5)+"_neighbor_sampling_v0.7.3.txt"))
