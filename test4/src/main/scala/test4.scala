...
object test4 {
  ...
  def main(args: Array[String]) = {
   ...
   // System.setProperty("hadoop.home.dir", "HADOOP_HOME");
    ...
    val data = sc.parallelize(input.take(1000)).map(line => line.split(",").map(elem => elem.trim))
    ...
    val result3 = result2.map( line => ( line(5), line(6), line(1) ) ).persist()
    ...
    val weight_local_map = sc.broadcast(weight_map.value)
    
    
    val g_rdd = result5.map{ line =>
      
     
       val sum_weight_value = weight_local_map.value(line._1._1,line._1._2,line._1._3)._1
       val sum_weight =   weight_local_map.value(line._1._1,line._1._2,line._1._3)._2
       val sum_pow_weight =  weight_local_map.value(line._1._1,line._1._2,line._1._3)._3
